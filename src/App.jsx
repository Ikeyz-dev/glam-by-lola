...
import { ArrowUpRight, MapPin, Phone, Mail, Instagram, ChevronDown, Star, Sparkles, Play } from "lucide-react";
              ...
              >
                <a href={`#${l.toLowerCase()}`} onClick={() => setMenuOpen(false)}
                  style={{
                    ...
                    color: C.ivory, textDecoration: "none", letterSpacing: "0.02em",
                  }}
                >{l}</a>
              </motion.div>
            ))}
          ...
          <Reveal delay={0.15}>
            <div style={{ display: "flex", flexDirection: "column", gap: 24, marginBottom: 48 }}>
              {[
                ...
                { icon: <Instagram size={16} color={C.gold} />, label: "Instagram", value: "@glam.by.lola", href: "https://instagram.com/glam.by.lola" },
              ].map(item => (
