...
import { ArrowUpRight, MapPin, Phone, Mail, Share2, ChevronDown, Star, Sparkles, Play } from "lucide-react";
                    ...
                    <Reveal delay={0.15}>
                        <div style={{ display: "flex", flexDirection: "column", gap: 24, marginBottom: 48 }}>
                            {[
                                ...
                                { icon: <Share2 size={16} color={C.gold} />, label: "Instagram", value: "@glam.by.lola", href: "https://instagram.com/glam.by.lola" },
                            ].map(item => (
